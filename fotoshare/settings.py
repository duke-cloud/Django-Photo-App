"""
Django settings for fotoshare project.
...
SECRET_KEY = 'x2zjvrq^t7-5uvro4nsg%6$-xyp@vq90_v^m_fdmv4uf3-&!wy'
...
WSGI_APPLICATION = 'fotoshare.wsgi.application'
